# -*- coding: utf-8 -*-
"""
生成第1章: 图像拼接模型 - Jupyter Notebook
"""
import json, os

nb_dir = r"d:\CODE\Hands-On-Computer-Vision\最优化算法与立体视觉重建\图像拼接模型"
...
cells.append({
    ...
    "source": [
        ...
        "    # 使用 OpenCV 的 findHomography (内部使用 RANSAC)\n",
...
cells.append({
    ...
    "source": [
        ...
        "\n",
        "# 保存结果\n",
        "cv2.imwrite('stitched_panorama.jpg', result_cropped)\n",
...
nb_path = os.path.join(nb_dir, "编程实践.ipynb")
with open(nb_path, 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print(f"Notebook 已生成: {nb_path}")
print(f"总 Cell 数: {len(cells)}")
code_cells = sum(1 for c in cells if c['cell_type'] == 'code')
md_cells = sum(1 for c in cells if c['cell_type'] == 'markdown')
print(f"  代码 Cell: {code_cells}")
print(f"  文档 Cell: {md_cells}")